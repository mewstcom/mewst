...
RSpec.describe "POST /latest/suggested_profiles/@:atname/check", type: :request, api_version: :latest do
  context "アットネームが正しくないとき" do
    ...
    it "`422` を返すこと" do
      post("/latest/suggested_profiles/@unknown/check", headers:)
  ...
  context "入力データが正しいとき" do
    ...
    it "`204` を返すこと" do
      ...
      post("/latest/suggested_profiles/@#{actor_b.atname}/check", headers:)
