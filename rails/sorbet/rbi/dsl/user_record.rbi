...
class UserRecord
  ...
  sig { params(unencrypted_password: T.untyped).returns(T.any(UserRecord, FalseClass)) }
  ...
  module CommonRelationMethods
    ...
    sig { params(args: T.untyped).returns(T::Array[::UserRecord]) }
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: T.any(Symbol, T::Array[Symbol])
      ).returns(T::Enumerator[T::Array[::UserRecord]])
    end
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `UserRecord` class because it declared `has_many :actor_records`.
