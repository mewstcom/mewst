...
# This is an autogenerated file for dynamic methods in `Posts::DestroyController`.
# Please instead update this file by running `bin/tapioca dsl Posts::DestroyController`.

class Posts::DestroyController
