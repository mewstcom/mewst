...
# This is an autogenerated file for dynamic methods in `Reposts::DestroyController`.
# Please instead update this file by running `bin/tapioca dsl Reposts::DestroyController`.

class Reposts::DestroyController
