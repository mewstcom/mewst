...
# This is an autogenerated file for dynamic methods in `Entries::DestroyController`.
# Please instead update this file by running `bin/tapioca dsl Entries::DestroyController`.

class Entries::DestroyController
