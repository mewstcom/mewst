...
# pkg:gem/sentry-rails#lib/sentry/rails/configuration.rb:10
class Sentry::Configuration
  # pkg:gem/sentry-rails#lib/sentry/rails/configuration.rb:11
  def rails; end
end
...
# pkg:gem/sentry-rails#lib/sentry/rails/configuration.rb:53
...
# pkg:gem/sentry-rails#lib/sentry/rails/configuration.rb:113
class Sentry::Rails::Configuration
  # pkg:gem/sentry-rails#lib/sentry/rails/configuration.rb:162
  def initialize; end
  ...
  #
  # pkg:gem/sentry-rails#lib/sentry/rails/configuration.rb:138
  ...
  #
  # pkg:gem/sentry-rails#lib/sentry/rails/configuration.rb:118
  ...
  #
  # pkg:gem/sentry-rails#lib/sentry/rails/configuration.rb:128
...
# pkg:gem/sentry-rails#lib/sentry/rails/configuration.rb:36
...
class Sentry::Railtie < ::Rails::Railtie
  # pkg:gem/sentry-rails#lib/sentry/rails/railtie.rb:132
  def activate_tracing; end

  # pkg:gem/sentry-rails#lib/sentry/rails/railtie.rb:81
  def configure_cron_timezone; end

  # pkg:gem/sentry-rails#lib/sentry/rails/railtie.rb:73
  def configure_project_root; end

  # pkg:gem/sentry-rails#lib/sentry/rails/railtie.rb:77
  def configure_trusted_proxies; end

  # pkg:gem/sentry-rails#lib/sentry/rails/railtie.rb:86
  def extend_controller_methods; end

  # pkg:gem/sentry-rails#lib/sentry/rails/railtie.rb:102
  def inject_breadcrumbs_logger; end

  # pkg:gem/sentry-rails#lib/sentry/rails/railtie.rb:124
  def override_streaming_reporter; end

  # pkg:gem/sentry-rails#lib/sentry/rails/railtie.rb:98
  def patch_background_worker; end

  # pkg:gem/sentry-rails#lib/sentry/rails/railtie.rb:141
  def register_error_subscriber(app); end

  # pkg:gem/sentry-rails#lib/sentry/rails/railtie.rb:116
