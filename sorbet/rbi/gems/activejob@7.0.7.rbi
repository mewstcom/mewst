...
#
# source://activejob//lib/active_job/queue_adapters/sucker_punch_adapter.rb#20
class ActiveJob::QueueAdapters::SuckerPunchAdapter
  # source://activejob//lib/active_job/queue_adapters/sucker_punch_adapter.rb#21
  def enqueue(job); end

  # source://activejob//lib/active_job/queue_adapters/sucker_punch_adapter.rb#31
  def enqueue_at(job, timestamp); end
end

# source://activejob//lib/active_job/queue_adapters/sucker_punch_adapter.rb#40
class ActiveJob::QueueAdapters::SuckerPunchAdapter::JobWrapper
  include ::SuckerPunch::Job
  extend ::SuckerPunch::Job::ClassMethods

  # source://sucker_punch/3.1.0/lib/sucker_punch/job.rb#24
  def num_jobs_max; end

  # source://sucker_punch/3.1.0/lib/sucker_punch/job.rb#24
  def num_jobs_max=(_arg0); end

  # source://sucker_punch/3.1.0/lib/sucker_punch/job.rb#24
  def num_jobs_max?; end

  # source://sucker_punch/3.1.0/lib/sucker_punch/job.rb#23
  def num_workers; end

  # source://sucker_punch/3.1.0/lib/sucker_punch/job.rb#23
  def num_workers=(_arg0); end

  # source://sucker_punch/3.1.0/lib/sucker_punch/job.rb#23
  def num_workers?; end

  # source://activejob//lib/active_job/queue_adapters/sucker_punch_adapter.rb#43
