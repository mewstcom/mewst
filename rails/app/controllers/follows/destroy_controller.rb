...
class Follows::DestroyController < ApplicationController
  ...
  def call
    @form = FollowForm.new(profile: viewer!.profile_record.not_nil!, target_atname: params[:atname])
    ...
    @follow_checker = FollowChecker.new(profile: viewer!.profile_record.not_nil!, target_profiles: [@profile])
