...
class FactoryBot::Definition
  ...
  # @api private
  #
  # source://factory_bot//lib/factory_bot/definition.rb#70
  def overridable; end
  ...
  # @api private
  #
  # source://factory_bot//lib/factory_bot/definition.rb#148
  ...
  # @api private
  #
  # source://factory_bot//lib/factory_bot/definition.rb#193
  def automatically_register_defined_enums(klass); end

  # @api private
  # @return [Boolean]
  #
  # source://factory_bot//lib/factory_bot/definition.rb#197
  def automatically_register_defined_enums?(klass); end
  ...
  # @api private
  #
  # source://factory_bot//lib/factory_bot/definition.rb#128
  def error_with_definition_name(error); end

  # @api private
  #
  # source://factory_bot//lib/factory_bot/definition.rb#178
  def expand_enum_traits(klass); end

  # @api private
  #
  # source://factory_bot//lib/factory_bot/definition.rb#161
  def initialize_copy(source); end

  # @api private
  #
  # source://factory_bot//lib/factory_bot/definition.rb#152
