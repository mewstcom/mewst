...
module GoodJob
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # source://good_job//lib/good_job.rb#330
    def cli?; end
    ...
    # @return [void]
    #
    # source://good_job//lib/good_job.rb#300
    ...
    #
    # source://good_job//lib/good_job.rb#324
    ...
    # @return [Boolean]
    #
    # source://good_job//lib/good_job.rb#318
    ...
    # @return [void]
    #
    # source://good_job//lib/good_job.rb#309
...
class GoodJob::Adapter
  ...
  # @return [Boolean]
  #
  # source://good_job//lib/good_job/adapter.rb#196
  ...
  # @return [Boolean]
  #
  # source://good_job//lib/good_job/adapter.rb#203
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/adapter.rb#183
  def shutdown(timeout: T.unsafe(nil)); end
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/adapter.rb#217
  def start_async; end
  ...
  #
  # source://good_job//lib/good_job/adapter.rb#242
  def perform_inline(job, notify: T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://good_job//lib/good_job/adapter.rb#233
...
class GoodJob::Configuration
  ...
  #
  # source://good_job//lib/good_job/configuration.rb#85
  ...
  # @return [Integer, Boolean, nil]
  #
  # source://good_job//lib/good_job/configuration.rb#295
  def cleanup_interval_seconds; end
  ...
  # @return [Integer]
  #
  # source://good_job//lib/good_job/configuration.rb#264
  def cleanup_preserved_jobs_before_seconds_ago; end

  # source://good_job//lib/good_job/configuration.rb#210
  def cron; end

  # source://good_job//lib/good_job/configuration.rb#220
  ...
  # @return [Boolean]
  #
  # source://good_job//lib/good_job/configuration.rb#313
  def daemonize?; end

  # source://good_job//lib/good_job/configuration.rb#356
  ...
  # @return [Boolean]
  #
  # source://good_job//lib/good_job/configuration.rb#376
  ...
  # @return [Hash]
  #
  # source://good_job//lib/good_job/configuration.rb#54
  def env; end
  ...
  # @return [Symbol]
  #
  # source://good_job//lib/good_job/configuration.rb#99
  def execution_mode; end
  ...
  #
  # source://good_job//lib/good_job/configuration.rb#245
  ...
  # @return [Boolean]
  #
  # source://good_job//lib/good_job/configuration.rb#167
  ...
  # @return [Integer]
  #
  # source://good_job//lib/good_job/configuration.rb#126
  def max_threads; end
  ...
  # @return [Integer]
  #
  # source://good_job//lib/good_job/configuration.rb#152
  ...
  # @return [Float]
  #
  # source://good_job//lib/good_job/configuration.rb#187
  def shutdown_timeout; end

  # source://good_job//lib/good_job/configuration.rb#92
  def validate!; end
  ...
  class << self
    ...
    # @return [Integer]
    #
    # source://good_job//lib/good_job/configuration.rb#59
...
class GoodJob::Scheduler::TimerSet < ::Concurrent::TimerSet
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/scheduler.rb#349
  def reset; end
end
