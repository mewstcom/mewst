...
Rails.application.routes.draw do
  ...
  match "/internal/password",                                             via: :patch,  as: :internal_password,                               to: "internal/passwords/update#call"
  ...
  match "/latest/suggested_profiles",                                     via: :get,    as: :latest_suggested_profile_list,                   to: "latest/suggested_profiles/index#call"
  match "/latest/suggested_profiles/@:atname/check",                      via: :post,   as: :latest_suggested_profile_check,                  to: "latest/suggested_profiles/checks/create#call"
