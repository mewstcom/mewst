...
Rails.application.routes.draw do
  ...
  match "/api/internal/pubsub/add_entry_to_home_timeline",   via: :post,   as: :internal_api_pubsub_add_entry_to_home_timeline,   to: "api/internal/pubsub/add_entry_to_home_timeline#call"
  match "/api/internal/pubsub/fanout_entry",                 via: :post,   as: :internal_api_pubsub_fanout_entry,                 to: "api/internal/pubsub/fanout_entry#call"
