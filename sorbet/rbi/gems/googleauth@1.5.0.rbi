...
class Google::Auth::ExternalAccount::AwsCredentials
  ...
  #
  # source://googleauth//lib/googleauth/external_account/aws_credentials.rb#77
  ...
  #
  # source://googleauth//lib/googleauth/external_account/aws_credentials.rb#178
  def fetch_metadata_role_name; end

  # Retrieves the AWS security credentials required for signing AWS
  # requests from the AWS metadata server.
  #
  # source://googleauth//lib/googleauth/external_account/aws_credentials.rb#188
  ...
  #
  # source://googleauth//lib/googleauth/external_account/aws_credentials.rb#150
  def fetch_security_credentials; end

  # source://googleauth//lib/googleauth/external_account/aws_credentials.rb#115
  ...
  # source://googleauth//lib/googleauth/external_account/aws_credentials.rb#139
  def uri_escape(string); end

  # source://googleauth//lib/googleauth/external_account/aws_credentials.rb#108
  def validate_metadata_server(url, name); end
end

# Implements an AWS request signer based on the AWS Signature Version 4 signing process.
# https://docs.aws.amazon.com/general/latest/gr/signature-version-4.html
#
# source://googleauth//lib/googleauth/external_account/aws_credentials.rb#208
class Google::Auth::ExternalAccount::AwsRequestSigner
  ...
  #
  # source://googleauth//lib/googleauth/external_account/aws_credentials.rb#232
  def generate_signed_request(aws_credentials, original_request); end

  private

  # source://googleauth//lib/googleauth/external_account/aws_credentials.rb#262
  def aws_headers(aws_credentials, original_request, datetime); end

  # source://googleauth//lib/googleauth/external_account/aws_credentials.rb#273
  ...
  #
  # source://googleauth//lib/googleauth/external_account/aws_credentials.rb#352
  def build_canonical_querystring(query); end

  # source://googleauth//lib/googleauth/external_account/aws_credentials.rb#330
  def canonical_request(http_method, uri, headers, content_sha256); end

  # source://googleauth//lib/googleauth/external_account/aws_credentials.rb#299
  def credential(access_key_id, date, service); end

  # source://googleauth//lib/googleauth/external_account/aws_credentials.rb#303
  def credential_scope(date, service); end

  # source://googleauth//lib/googleauth/external_account/aws_credentials.rb#295
  def hexhmac(key, value); end

  # source://googleauth//lib/googleauth/external_account/aws_credentials.rb#291
  def hmac(key, value); end

  # source://googleauth//lib/googleauth/external_account/aws_credentials.rb#321
  def host(uri); end

  # source://googleauth//lib/googleauth/external_account/aws_credentials.rb#343
  def sha256_hexdigest(string); end

  # source://googleauth//lib/googleauth/external_account/aws_credentials.rb#282
  def signature(secret_access_key, date, string_to_sign, service); end

  # source://googleauth//lib/googleauth/external_account/aws_credentials.rb#312
...
class Google::Auth::ExternalAccount::Credentials
  class << self
    ...
    def is_service_account_impersonation_url_valid?(url); end

    # @return [Boolean]
    #
    # source://googleauth//lib/googleauth/external_account.rb#101
    def is_token_url_valid?(url); end

    # @return [Boolean]
    #
    # source://googleauth//lib/googleauth/external_account.rb#89
    def is_valid_url?(url, valid_hostnames); end
    ...
    #
    # source://googleauth//lib/googleauth/external_account.rb#53
    def make_creds(options = T.unsafe(nil)); end

    # Reads the required fields from the JSON.
    #
    # source://googleauth//lib/googleauth/external_account.rb#78
...
# source://googleauth//lib/googleauth/external_account.rb#41
Google::Auth::ExternalAccount::Credentials::SERVICE_ACCOUNT_IMPERSONATION_URL_PATTERNS = T.let(T.unsafe(nil), Array)

# source://googleauth//lib/googleauth/external_account.rb#33
Google::Auth::ExternalAccount::Credentials::TOKEN_URL_PATTERNS = T.let(T.unsafe(nil), Array)
