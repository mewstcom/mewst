...
# This is an autogenerated file for dynamic methods in `Reposts::CreateController`.
# Please instead update this file by running `bin/tapioca dsl Reposts::CreateController`.

class Reposts::CreateController
