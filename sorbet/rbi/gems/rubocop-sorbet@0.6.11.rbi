...
class RuboCop::Cop::Style::MutableConstant < ::RuboCop::Cop::Base
  ...
  # source://rubocop/1.39.0/lib/rubocop/cop/style/mutable_constant.rb#127
  def on_casgn(node); end

  # source://rubocop/1.39.0/lib/rubocop/cop/style/mutable_constant.rb#224
  def operation_produces_immutable_object?(param0 = T.unsafe(nil)); end

  # source://rubocop/1.39.0/lib/rubocop/cop/style/mutable_constant.rb#241
  def range_enclosed_in_parentheses?(param0 = T.unsafe(nil)); end

  # source://rubocop/1.39.0/lib/rubocop/cop/style/mutable_constant.rb#217
  ...
  # source://rubocop/1.39.0/lib/rubocop/cop/style/mutable_constant.rb#169
  def autocorrect(corrector, node); end

  # source://rubocop/1.39.0/lib/rubocop/cop/style/mutable_constant.rb#158
  def check(value); end

  # source://rubocop/1.39.0/lib/rubocop/cop/style/mutable_constant.rb#208
  def correct_splat_expansion(corrector, expr, splat_value); end

  # source://rubocop/1.39.0/lib/rubocop/cop/style/mutable_constant.rb#200
  def frozen_regexp_or_range_literals?(node); end

  # source://rubocop/1.39.0/lib/rubocop/cop/style/mutable_constant.rb#190
  def immutable_literal?(node); end

  # source://rubocop/1.39.0/lib/rubocop/cop/style/mutable_constant.rb#184
  def mutable_literal?(value); end

  # source://rubocop/1.39.0/lib/rubocop/cop/style/mutable_constant.rb#204
  def requires_parentheses?(node); end

  # source://rubocop/1.39.0/lib/rubocop/cop/style/mutable_constant.rb#194
  def shareable_constant_value?(node); end

  # source://rubocop/1.39.0/lib/rubocop/cop/style/mutable_constant.rb#149
  def strict_check(value); end
end

# source://rubocop/1.39.0/lib/rubocop/cop/style/mutable_constant.rb#125
