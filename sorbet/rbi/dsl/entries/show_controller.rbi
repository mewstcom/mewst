...
# This is an autogenerated file for dynamic methods in `Entries::ShowController`.
# Please instead update this file by running `bin/tapioca dsl Entries::ShowController`.

class Entries::ShowController
