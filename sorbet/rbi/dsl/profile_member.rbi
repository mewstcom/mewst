...
# This is an autogenerated file for dynamic methods in `ProfileMember`.
# Please instead update this file by running `bin/tapioca dsl ProfileMember`.
...
class ProfileMember
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::ProfileMember).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end
    ...
    sig do
      params(
        ...
        block: T.nilable(T.proc.params(object: ::ProfileMember).void)
      ).returns(::ProfileMember)
    end
    ...
    sig { returns(T::Array[::ProfileMember]) }
    def destroy_all; end

    sig { params(conditions: T.untyped).returns(T::Boolean) }
    def exists?(conditions = :none); end

    sig { returns(T.nilable(::ProfileMember)) }
    def fifth; end

    sig { returns(::ProfileMember) }
    def fifth!; end

    sig { params(args: T.untyped).returns(T.untyped) }
    def find(*args); end

    sig { params(args: T.untyped).returns(T.nilable(::ProfileMember)) }
    def find_by(*args); end

    sig { params(args: T.untyped).returns(::ProfileMember) }
    def find_by!(*args); end
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.nilable(T.proc.params(object: ::ProfileMember).void)
      ).returns(T.nilable(T::Enumerator[::ProfileMember]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::ProfileMember]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::ProfileMember]]))
    end
    ...
    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(T.nilable(::ProfileMember)) }
    def find_signed(signed_id, purpose: nil); end

    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(::ProfileMember) }
    def find_signed!(signed_id, purpose: nil); end

    sig { params(arg: T.untyped, args: T.untyped).returns(::ProfileMember) }
  ...
  class PrivateAssociationRelation < ::ActiveRecord::AssociationRelation
    ...
    Elem = type_member { { fixed: ::ProfileMember } }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::ProfileMember, T::Enumerable[T.any(::ProfileMember, T::Enumerable[::ProfileMember])])
    ...
    sig do
      params(
        records: T.any(::ProfileMember, Integer, String, T::Enumerable[T.any(::ProfileMember, Integer, String, T::Enumerable[::ProfileMember])])
      ).returns(T::Array[::ProfileMember])
    end
    ...
    sig do
      params(
        other_array: T.any(::ProfileMember, T::Enumerable[T.any(::ProfileMember, T::Enumerable[::ProfileMember])])
      ).returns(T::Array[::ProfileMember])
    end
