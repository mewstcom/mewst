...
class Profile
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `Profile` class because it declared `has_many :notifications`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
    ...
    # This method is created by ActiveRecord on the `Profile` class because it declared `has_many :stamps`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
