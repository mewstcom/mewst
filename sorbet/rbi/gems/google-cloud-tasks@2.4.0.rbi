...
module Google::Cloud::Tasks
  class << self
    ...
    #
    # source://google-cloud-tasks//lib/google/cloud/tasks.rb#70
    def cloud_tasks(version: T.unsafe(nil), transport: T.unsafe(nil), &block); end
    ...
    #
    # source://google-cloud-tasks//lib/google/cloud/tasks.rb#110
    def configure; end
  end
end
