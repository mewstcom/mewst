...
module ActiveJob
  class << self
    # source://activejob/7.1.5/lib/active_job/queue_adapter.rb#7
    def adapter_name(adapter); end

    # source://activejob/7.1.5/lib/active_job/deprecator.rb#4
    def deprecator; end

    # source://activejob/7.1.5/lib/active_job/gem_version.rb#5
    def gem_version; end

    # source://activejob/7.1.5/lib/active_job/enqueuing.rb#14
    def perform_all_later(*jobs); end

    # source://activejob/7.1.5/lib/active_job.rb#56
    def use_big_decimal_serializer; end

    # source://activejob/7.1.5/lib/active_job.rb#56
    def use_big_decimal_serializer=(_arg0); end

    # source://activejob/7.1.5/lib/active_job.rb#64
    def verbose_enqueue_logs; end

    # source://activejob/7.1.5/lib/active_job.rb#64
    def verbose_enqueue_logs=(_arg0); end

    # source://activejob/7.1.5/lib/active_job/version.rb#7
    def version; end

    private

    # source://activejob/7.1.5/lib/active_job/instrumentation.rb#6
...
module ActiveJob::QueueAdapters
  class << self
    # source://activejob/7.1.5/lib/active_job/queue_adapters.rb#137
    def lookup(name); end
  end
end
