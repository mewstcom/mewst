...
# This is an autogenerated file for dynamic methods in `TwitterFriends::IndexController`.
# Please instead update this file by running `bin/tapioca dsl TwitterFriends::IndexController`.

class TwitterFriends::IndexController
